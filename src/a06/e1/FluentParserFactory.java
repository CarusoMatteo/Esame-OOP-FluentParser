...
/**
 * An interface modelling a factory of several FluentParsers, which are all
 * deterministic,
...
public interface FluentParserFactory {
     ...
     * @return (assuming s is "a") a parser accepting
     *         "a","a","aa","a","aa","aaa","a",...
     */
     ...
     * @return (assuming i0=0, op=i->i+2, s="a") a parser accepting pairs *
     *         <0,()>,<2,(a,a)>,<4,(a,a,a,a)>...
     */
